...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.PaymentMethodInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).paymentMethod.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.PaymentMethodInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).paymentMethod.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.PaymentMethodInputSchema.findFirst).query(({ ctx, input }) => checkRead(db(ctx).paymentMethod.findFirst(input as any))),

        findMany: procedure.input($Schema.PaymentMethodInputSchema.findMany).query(({ ctx, input }) => checkRead(db(ctx).paymentMethod.findMany(input as any))),
